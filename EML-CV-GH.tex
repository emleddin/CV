...
\section{Technical Skills}
  \resumeSubHeadingListStart
    \resumeSubItem{Computer-Based:}
      {Proficient with AMBER19, Avogadro, ChemDraw, Gaussian16, Gnuplot, iBabel, LoggerPro, UCSF Chimera, Visual Molecular Dynamics, \LaTeX, and Windows, Mac, and Linux Operating Systems. Familiar with Gimp, ImageJ, PyRx, Python, R, and Mathematica. }
