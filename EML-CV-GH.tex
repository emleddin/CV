...
%\usepackage[charter]{mathdesign} %C% harter math (for kappa)
...
%% ORCID and GitHub
  \begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \href{http://orcid.org/0000-0003-1610-0092}{ORCID: 0000-0003-1610-0092} & \href{https://github.com/emleddin}{GitHub: emleddin}\\
\end{tabular*}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{\textnormal{Performed molecular dynamics simulations with DNA polymerase $\kappa$, TET2, HRP, and RdRp}}
          {}
        \resumeItem{\textnormal{Parameterized non-standard nucleic acids and small ligands}}
          {}
        \resumeItem{\textnormal{Optimized protein complexes using quantum mechanics/molecular mechanics}}
          {}
...
\small
%% June 4, 2021
   \item \href{https://doi.org/10.1021/acs.jctc.1c00313}{Hix, M. A.; Leddin, E. M.; Cisneros, G. A. Combining Evolutionary Conservation and Quantum Topological Analyses to Determine QM Subsystems for Biomolecular QM/MM Simulations.
\textit{JCTC} [Online early access]. Published Online: June 4, 2021. https://pubs.acs.org/doi/10.1021/acs.jctc.1c00313} 
%% Accepted May 2019
   ...
   \resumeSubItem{Out in Science, Technology, Engineering, and Mathematics (oSTEM)}
      {(2018 -- Present)}
        ...
        \resumeItem{Graduate Student Networking Chair\textnormal{:}}
          {Facilitated discussions on graduate and professional school options, lead coding workshops, and built and maintained the \href{https://ostemnorthtexas.github.io/site/index.html}{organization's website}} 
        \resumeItem{Hackathon Participant\textnormal{:}}
          {Worked with a team of 4 students and 2 professional mentors to develop and pitch a product based on client goals over the course of 48 hours (\href{https://github.com/travigd/NarwhalApp}{2019, first place}; \href{https://github.com/camryn-e/QueersInCrisis}{2020, third place})}
      \resumeItemListEnd
