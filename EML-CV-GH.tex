...
\section{Awards and Honors}
  \resumeSubHeadingListStart
   ...
   \resumeSubItem{First Place \href{https://github.com/travigd/NarwhalApp}{Project}\textnormal{,}}
      {9\textsuperscript{th} Annual \emph{o}STEM Conference Hackathon (2019)}
...
\section{Technical Skills}
  \resumeSubHeadingListStart
    \resumeSubItem{Computer-Based:}
      {Proficient with AMBER20; Avogadro; ChemDraw; Gaussian16; Git version control; GitHub project management; Gnuplot; iBabel; LoggerPro; UCSF Chimera; Visual Molecular Dynamics; \LaTeX; Microsoft Word, Excel, and PowerPoint; and Windows, Mac, and Linux Operating Systems. Familiar with CAVER, Gimp, GROMACS, HTML/CSS, ImageJ, Jekyll, LICHEM, PLINK, PyRx, SPSS, TINKER, Python (Matplotlib, MDAnalysis, Numpy, Pandas, ParmEd), R (data.table, tidyverse), and RMarkdown. }
